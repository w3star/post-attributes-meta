// blocks/owww-explorer/view.js — stabile Wrapper-Drag-Variante (ein Skript, kein Umschalten in input)
(function () {
  ...
  function diffLabel(i) { i = parseInt(i || 0, 10); return i === 1 ? 'T1' : (i === 2 ? 'T2' : (i === 3 ? 'T3' : (i === 4 ? 'T4' : (i === 5 ? 'T5' : 'T6')))); }
